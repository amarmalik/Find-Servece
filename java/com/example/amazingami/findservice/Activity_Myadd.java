...
ListView listupdatepost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__my__post);
        ...
        iv_updatepost_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Activity_Myadd.this,Menu_Holder.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void makeJsonObjReq2() {
        ...
        pb.show();
//--Replace your url
        final String urlweb = Url.GetUrl("http://ezeonsoft.in/ezeadd/view_myadd_grocery.php?"+"user_id="+SessionForm.GetSharedPreferences(SessionForm.KEY_user_id,Activity_Myadd.this));
...
//----
    ...
    public void customalert(String Msg, Activity act) {
        ...
        TextView tvsearch = (TextView) dialog.findViewById(R.id.txtmsg);
