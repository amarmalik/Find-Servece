...
import static com.example.amazingami.findservice.R.layout.activity_search;

/**
 * Created by Amazing Ami on 22-06-2017.
 */
...
@Override
    ...
    iv_city_back.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent i=new Intent(Activity_search.this,Menu_Holder.class);
            startActivity(i);
            finish();
        }
    });
    ...
    private void makeJsonObjReq2() {
        ...
        final ProgressDialog pb = new ProgressDialog(Activity_search.this);
...
//---Try catch block and your other parsing
                        ...
                        try {
                            ...
                            if(status.equals("1"))
                            {
                                ...
                                Adapter_Search adcity=new Adapter_Search(Activity_search.this,listf);
                            ...
                            {
                                customalert(message,Activity_search.this);
                            }
...
//
                            ...
                            ex.printStackTrace();
                            customalert("Something went wrong please check",Activity_search.this);
