...
public class Adapter_Myadd extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvcost = (TextView) vi.findViewById(R.id.tvcost);
        TextView tvdiscription = (TextView) vi.findViewById(R.id.tvdiscription);
        TextView tvname = (TextView) vi.findViewById(R.id.tvname);
        TextView tvemail = (TextView) vi.findViewById(R.id.tvemail);
        TextView tvcontact = (TextView) vi.findViewById(R.id.tvcontact);
        ...
        String strcost = cmap.get(SessionForm.KEY_add_price);
        String strdiscription = cmap.get(SessionForm.KEY_add_description);
        String strname = cmap.get(SessionForm.KEY_owner_name);
        String strmail = cmap.get(SessionForm.KEY_owner_email);
        String strcontact = cmap.get(SessionForm.KEY_owner_mobile);


        tvdiscription.setText(strdiscription);
        tvtitle.setText(strtitle);
        tvcost.setText(strcost);
...
//--Replace your url
        ...
        final String urlweb= Url.GetUrl("http://ezeonsoft.in/ezeadd/deleteadd.php?"+"add_id="+selectedaddid);
...
//
                            ...
                            if(status.equals("1"))
                            {
                                ...
                                Intent i=new Intent(ctx,Menu_Holder.class);
                                ctx.startActivity(i);
                              //  ctx.finish();
                            }
                            else
