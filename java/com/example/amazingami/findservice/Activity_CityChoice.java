    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnserchcity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Activity_CityChoice.this,Menu_Holder.class);
        ...
        iv_choose_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activity_CityChoice.this, Menu_Holder.class);
                startActivity(i);
                finish();
            }
        });
...
//----
    ...
    private void AreaSpinnermakeJsonObjReq2() {
        ...
        pb.show();
//--Replace your url
        final String urlweb = Url.GetUrl("http://ezeonsoft.in/ezeadd/view_area.php?"+"city_id="+selectedcityid);
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                urlweb, null,
                new Response.Listener<JSONObject>() {
